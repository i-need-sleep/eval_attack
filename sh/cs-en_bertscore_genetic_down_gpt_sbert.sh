#!/bin/bash
#SBATCH --job-name=cs-en_bertscore_genetic_down_gpt_sbert       # 任务名
...
python -u poc.py \
    ...
    --read_path bertscore_faster_genetic_aggregated_cs-en_bertscore_bertscore_down_1.0_gpt10.0_sbert0.9
echo "FINISH"                       # 输出起始信息

#!/bin/bash
#SBATCH --job-name=bleurt-20-d12_clare_down_gpt_sbert       # 任务名
...
python -u poc.py \
    ...
    --attack_algo clare
    # --read_path 20-d12_clare_aggregated_de-en_bleurt-20-d12_bleurt_bleurt-20-d12_down_1.0_gpt10.0_sbert0.9
echo "FINISH"                       # 输出起始信息
